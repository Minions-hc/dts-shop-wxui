    ...
    >
      ...
      <swiper-item>
        <scroll-view 
          ...
          @scroll="e => onScroll(e, 0)"
        >
          <view class="period-tag" :style="{opacity: periodOpacity}">第 1 期</view>
          <view class="win-list">
            <view 
          ...
          <view class="all-users-grid">
            ...
            >
              <view class="avatar-wrapper">
                ...
                <view class="count-badge">{{ user.count }}</view>
              </view>
